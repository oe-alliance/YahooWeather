    ...
    def updateInfo(self):
        ...
        try:
            ...
            if dom:
                ...
                icon = '/usr/lib/enigma2/python/Plugins/Extensions/YahooWeather/Icon/%s.png' % str(weather_data['condition']['code'])
                ...
                icon = '/usr/lib/enigma2/python/Plugins/Extensions/YahooWeather/Icon/%s.png' % str(weather_data['forecasts'][0]['code'])
                myicon = self.checkIcon(icon)
                #png = loadPic(myicon, 81, 72, 0, 0, 0, 0)
                ...
                icon = '/usr/lib/enigma2/python/Plugins/Extensions/YahooWeather/Icon/%s.png' % str(weather_data['forecasts'][1]['code'])
                myicon = self.checkIcon(icon)
                png = loadPic(myicon, 81, 59, 0, 0, 0, 0)
                ...
                icon = '/usr/lib/enigma2/python/Plugins/Extensions/YahooWeather/Icon/%s.png' % str(weather_data['forecasts'][2]['code'])
                myicon = self.checkIcon(icon)
                png = loadPic(myicon, 81, 59, 0, 0, 0, 0)
                ...
                icon = '/usr/lib/enigma2/python/Plugins/Extensions/YahooWeather/Icon/%s.png' % str(weather_data['forecasts'][3]['code'])
                myicon = self.checkIcon(icon)
                png = loadPic(myicon, 81, 59, 0, 0, 0, 0)
                ...
                icon = '/usr/lib/enigma2/python/Plugins/Extensions/YahooWeather/Icon/%s.png' % str(weather_data['forecasts'][4]['code'])
                myicon = self.checkIcon(icon)
                png = loadPic(myicon, 81, 59, 0, 0, 0, 0)
